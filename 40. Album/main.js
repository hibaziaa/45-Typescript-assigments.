...
var album1 = make_album("Asim Azhar", "Bematlab");
console.log(album1);
var album2 = make_album("Karan Aujla", "Making Memories");
console.log(album2);
var album3 = make_album("Talhah Anjum", "Open Letters");
console.log(album3);
//one that contain optional parameter too.
var album4 = make_album("Talhah Yunus", "Sukoon", 10);
console.log(album4);
