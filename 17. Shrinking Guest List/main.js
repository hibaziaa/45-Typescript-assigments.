...
console.log("It is to inform you that fortunately we have arranged a bigger table to invite more respectable guests");
...
console.log("We're extremley sorry to our guests but we can not invite more than two people for the upcoming dinner.");
// Remove guests from your list one at a time until only two names remain in your list. Each time you pop a name from your list, print a message to that person letting them know you’re sorry you can’t invite them to dinner.
while (guestsname.length > 2) {
    var removedGuests = guestsname.pop();
    console.log("Unfortunately due to some inconvenience we can't invite ".concat(removedGuests, " to the dinner."));
}
